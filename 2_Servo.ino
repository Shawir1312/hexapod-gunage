...
void activeLeg1() {
  if (calibStA == 1)srv_1A.attach(a1, 600, 2400); srv_1A.write(pos_1A); delay(tunda);
  if (calibStB == 1)srv_1B.attach(b1, 600, 2400); srv_1B.write(pos_1B); delay(tunda);
  if (calibStC == 1)srv_1C.attach(c1, 600, 2400); srv_1C.write(pos_1C);//delay(tunda);
}

void activeLeg2() {
  if (calibStA == 1)srv_2A.attach(a2, 600, 2400); srv_2A.write(pos_2A); delay(tunda);
  if (calibStB == 1)srv_2B.attach(b2, 600, 2400); srv_2B.write(pos_2B); delay(tunda);
  if (calibStC == 1)srv_2C.attach(c2, 600, 2400); srv_2C.write(pos_2C);//delay(tunda);
}

void activeLeg3() {
  if (calibStA == 1)srv_3A.attach(a3, 600, 2400); srv_3A.write(pos_3A); delay(tunda);
  if (calibStB == 1)srv_3B.attach(b3, 600, 2400); srv_3B.write(pos_3B); delay(tunda);
  if (calibStC == 1)srv_3C.attach(c3, 600, 2400); srv_3C.write(pos_3C);//delay(tunda);
}

void activeLeg4() {
  if (calibStA == 1)srv_4A.attach(a4, 600, 2400); srv_4A.write(pos_4A); delay(tunda);
  if (calibStB == 1)srv_4B.attach(b4, 600, 2400); srv_4B.write(pos_4B); delay(tunda);
  if (calibStC == 1)srv_4C.attach(c4, 600, 2400); srv_4C.write(pos_4C);//delay(tunda);
}

void activeLeg5() {
  if (calibStA == 1)srv_5A.attach(a5, 600, 2400); srv_5A.write(pos_5A); delay(tunda);
  if (calibStB == 1)srv_5B.attach(b5, 600, 2400); srv_5B.write(pos_5B); delay(tunda);
  if (calibStC == 1)srv_5C.attach(c5, 600, 2400); srv_5C.write(pos_5C);//delay(tunda);
}

void activeLeg6() {
  if (calibStA == 1)srv_6A.attach(a6, 600, 2400); srv_6A.write(pos_6A); delay(tunda);
  if (calibStB == 1)srv_6B.attach(b6, 600, 2400); srv_6B.write(pos_6B); delay(tunda);
  if (calibStC == 1)srv_6C.attach(c6, 600, 2400); srv_6C.write(pos_6C);//delay(tunda);
}
